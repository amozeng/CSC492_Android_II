...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        for (Geofence g : triggeringGeofences) {
            ...
            GeoFenceData fd = GeoFenceManager.getFenceData(g.getRequestId());
            sendNotification(context, fd);
        }
    }


    public void sendNotification(Context context, GeoFenceData fd) {
        ...
        // You could build a pending intent here to oinitializepen an activity when the
        // notification is tapped. Not doing that here though.

        Intent resultIntent = new Intent(context.getApplicationContext(), InfoActivity.class);
